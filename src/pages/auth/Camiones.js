...
const Camiones = () => {
    return (
        ...
        <div>
            <h3 class="text-center my-5 text-2xl font-bold tracking-tight text-gray-900">En esta seccion encontrarás los diversos camiones de las empresas que manejamos</h3>
