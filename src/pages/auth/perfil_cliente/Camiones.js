...
const Camiones = () => {
    ...
    const manejarBusqueda = (e) => {
        ...
        // Filtra los camiones que tienen la capacidad suficiente
        const camionesFiltrados = camiones.filter(camion => camion.capacidad >= cargaDeseada);
    ...
    return (
        ...
        <section className="place-content-center justify-items-center gap-8 mt-5 mb-5">
            ...
            {/* Barra de búsqueda */}
            <h3 className="text-center mb-4 text-2xl font-bold tracking-tight text-gray-900">Puedes ingresar la carga para aconcejarte el mejor camion</h3>
