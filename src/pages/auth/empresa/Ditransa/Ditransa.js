...
const Ditransa = () => {
    return (
        ...
        <Header/>
        <div>
            <h2 class="text-center mt-5 mb-3 text-3xl font-bold tracking-tight text-gray-900">BIENVENIDO A LA EMPRESA DE TRANSPORTE DITRANSA</h2>
            <p class="text-center mb-5 text-lg font-bold tracking-tight text-gray-900">En esta empresa brindamos transporte de carga en la ciudad de Medellin</p>
            <h3 class="text-center text-lg font-bold tracking-tight text-gray-900">Ingresa el peso de la carga para aconcejarte el mejor camion</h3>
        ...
        <section class="flex flex-row place-content-center justify-items-center gap-8 mt-5 mb-5">
                <div class="max-w-sm bg-white  rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="p-5">
                        ...
                        <a href="Ditransa1" class=" mt-4 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-orange-500 rounded-lg hover:bg-orange-700 focus:ring-4 focus:outline-none focus:ring-gray-300">
                            Consultar camion
