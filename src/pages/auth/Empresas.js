...
const Empresas = () => {
    return (
        ...
        <div>
            <h3 class="text-center my-5 text-2xl font-bold tracking-tight text-gray-900">En esta seccion encontrarás las diversas empresas de transporte que manejamos</h3>
