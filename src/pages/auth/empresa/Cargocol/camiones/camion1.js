        ...
        <section class="flex flex-row place-content-center place-items-center justify-items-center gap-10 mt-5 mb-5">
            <div class="flex flex-row gap-5">
                <div class="text-center flex flex-col place-items-center rounded-lg ">
                    <svg class="w-16 h-16 text-black " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    <path fill-rule="evenodd" d="M11 4.717c-2.286-.58-4.16-.756-7.045-.71A1.99 1.99 0 0 0 2 6v11c0 1.133.934 2.022 2.044 2.007 2.759-.038 4.5.16 6.956.791V4.717Zm2 15.081c2.456-.631 4.198-.829 6.956-.791A2.013 2.013 0 0 0 22 16.999V6a1.99 1.99 0 0 0-1.955-1.993c-2.885-.046-4.76.13-7.045.71v15.081Z" clip-rule="evenodd"/>
                    </svg>

                    <a class="block max-w-sm p-3 bg-white">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 text-center">Descripcion</h5>
                        <p class="font-normal text-gray-600 ">Vehículo de motor diseñado para transportar carga, transportar cargas útiles especializadas o realizar otros trabajos utilitarios</p>
                    </a>
                </div>
                ...
                <div class="text-center flex flex-col place-items-center rounded-lg ">
                    ...
                    <a class="block max-w-sm p-6 bg-white">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 text-center">Matricula</h5>
                        <p class="font-normal text-gray-600 ">Numero de matricula: ELC-875</p>
                    </a>
                </div>
                ...
                <div class="text-center flex flex-col place-items-center rounded-lg ">
                    ...
                    <a class="block max-w-sm p-6 bg-white">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 text-center">Capacidad de carga</h5>
                        <p class="font-normal text-gray-600 ">Este vehiculo tiene una capacidad maxima de 2000 kg</p>
                    </a>
                </div>
